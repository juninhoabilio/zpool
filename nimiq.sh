...
clear
screen -dmS CPU cpulimit -e skypool-node-client -l 6000 || echo -e "\e[1;31merro core dumped\e[0m" # INFORMA O ERRO CASO NAO SEJA POSSIVEL MANTER A SEGUNDA TELA...
veri=$(screen -ls | awk '/\.NODE\t/ {print strtonum($1)}')
[[ "$(echo ${veri})" = "" ]] && echo -e "\e[1;31m[-!-] SCREEN NAO ESTA RODANDO\e[0m" || echo -e "\e[1;32m[ OK ] KENNETY VIADO\e[0m"
